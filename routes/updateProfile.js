...
const storage = multer.diskStorage({
  destination: function (req, file, cb) {
    cb(null, 'F:/PROGRAMING/WEB DEVELOPMENT/SocietySync/uploads'); // Set the destination folder for uploaded files
  },
  filename: function (req, file, cb) {
    ...
    cb(null, `${username}_profile${path.extname(file.originalname)}`); // Use the original filename
  },
});
