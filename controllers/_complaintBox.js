...
async function _newComplaintPOST(req, res) {
  ...
  if (req.body.id) {
    res.render("F:/PROGRAMING/WEB DEVELOPMENT/SocietySync/templates/complaintBox.ejs",{"userId":req.body.id});
  } else {
    try {
...
async function _complaintImages(req,res){
  ...
  res.render("F:/PROGRAMING/WEB DEVELOPMENT/SocietySync/templates/complaintImages.ejs",{images:images})
}

module.exports = { _newComplaintGET, _newComplaintPOST,_complaintManagerGet, _complaintImages, _complaintManagerPOST};